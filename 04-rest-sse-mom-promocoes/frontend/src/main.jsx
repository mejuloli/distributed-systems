...
function App() {
  ...
  async function seguir() {
    const categoria = categoriaInteresse.trim().toLowerCase();
    if (!categoria) return;
  ...
  return (
    <main className="pagina">
      <header className="hero">
        <div className="hero__conteudo">
          ...
          <div className="metricas">
            <span className="metrica metrica--promocoes">
              {promocoes.length} promoções
            </span>

            <span className="metrica metrica--interesses">
              {interesses.length} interesses
            </span>

            <span className="metrica metrica--hot">
              {totalHotDeals} hot deals
            </span>
          </div>
        </div>

        <button className="botao botao--claro" onClick={carregarPromocoes}>
      ...
      <section className="painel">
        <form className="cartao cartao--form" onSubmit={cadastrar}>
          <div className="titulo-card">
            ...
            <div>
              ...
              <p>Simula a loja enviando uma promoção assinada digitalmente.</p>
            </div>
          </div>
          ...
          <label className="campo">
            ...
            <div className="entrada-com-icone">
              ...
              <input
                value={form.loja_email}
                onChange={(e) => alterarCampo('loja_email', e.target.value)}
              />
            </div>
          </label>
        ...
        <div className="coluna-lateral">
          <aside className="cartao cartao--interesses">
            <div className="titulo-card">
          ...
          <aside className="cartao cartao--resumo">
            <div className="titulo-card">
        ...
        {notificacoes.length === 0 ? (
          <div className="estado-vazio estado-vazio--bloco estado-vazio--centro">
            ...
            <div>
              ...
              <p>Siga uma categoria e cadastre uma promoção relacionada.</p>
            </div>
          </div>
        ) : (
          <ul className="timeline">
            {notificacoes.map((item, indice) => (
              <li
                key={`${item.promocao_id || item.tipo}-${indice}`}
                className={classeEvento(item.tipo)}
              >
        ...
        {promocoes.length === 0 ? (
          <div className="estado-vazio estado-vazio--bloco estado-vazio--centro">
            ...
            <div>
              ...
              <p>Cadastre uma promoção no formulário acima para começar.</p>
            </div>
          </div>
        ) : (
          <div className="lista">
            {promocoes.map((promo) => (
              <article
                key={promo.promocao_id}
                className={promo.hot_deal ? 'promo promo--hot' : 'promo'}
              >
                <div className="promo__topo">
                  <span className={`badge ${classeCategoria(promo.categoria)}`}>
                    {promo.categoria}
                  </span>
